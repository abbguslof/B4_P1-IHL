...
const String location = "Kafeterian"; // Väljer vilken tabell under datumet
const int tableIndex = 4;             // Väljer platts i firebase. Vilken temp/hum x den ska skriva till
