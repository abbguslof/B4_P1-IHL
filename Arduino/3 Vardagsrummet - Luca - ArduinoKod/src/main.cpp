...
const String location = "Vardagsrummet"; // Väljer vilken tabell under datumet
const int tableIndex = 3;                // Väljer platts i firebase. Vilken temp/hum x den ska skriva till
