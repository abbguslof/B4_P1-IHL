...
const String location = "Klassrummet"; // Väljer vilken tabell under datumet
const int tableIndex = 1;              // Väljer platts i firebase. Vilken temp/hum x den ska skriva till
