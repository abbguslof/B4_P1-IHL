...
const String location = "Pingisrummet"; // Väljer vilken tabell under datumet
const int tableIndex = 5;               // Väljer platts i firebase. Vilken temp/hum x den ska skriva till
