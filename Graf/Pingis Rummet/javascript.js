...
let dataBaseRef4 = ref(db, "Temp5/Current")
onValue(dataBaseRef4, (snapshot) => {
    ...
    function Farenheit () {
        ...
        if (checkbutton == false) {
            document.getElementById("klassrum5-temp").innerHTML = tempC + grader + "C"
        }
        else {
            document.getElementById("klassrum5-temp").innerHTML = tempF + grader + "F"
        }
