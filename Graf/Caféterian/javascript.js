...
let dataBaseRef4 = ref(db, "Temp4/Current")
onValue(dataBaseRef4, (snapshot) => {
    ...
    function Farenheit () {
        ...
        if (checkbutton == false) {
            document.getElementById("klassrum4-temp").innerHTML = tempC + grader + "C"
        }
        else {
            document.getElementById("klassrum4-temp").innerHTML = tempF + grader + "F"
        }
...
let humref2 = ref(db, "Hum4/Current")
